    ...
    return (
        <div className='min-h-screen bg-[#fff9f6] flex items-center justify-center p-6'>
            ...
            <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6'>
                ...
                <section>
                    <h2 className='text-lg font-semibold mb-3 to-gray-800'>Payment Method</h2>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition cursor-pointer
                             ${paymentMethod === 'cod' ? "border-[#ff4d2d] bg-orange-50 shadow" :
                            ...
                            <div >
                                ...
                                <p className='font-xs text-gray-800'>Pay when your food arrives</p>
                            </div>
                        </div>
                        <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition  cursor-pointer
                            ${paymentMethod === 'online' ? "border-[#ff4d2d] bg-orange-50 shadow" :
                            ...
                            <div>
                                ...
                                <p className='text-xs to-gray-500'>Pay Securely Online</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className='rounded-xl border bg-gray-50 p-4 sapce-y-2'>
