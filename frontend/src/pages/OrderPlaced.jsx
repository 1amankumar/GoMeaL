...
function OrderPlaced() {
    ...
    return (
        <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
            <FaCircleCheck className='text-green-500 text-9xl mb-4' />
            <h1 className='text-3xl font-bold text-gray-800 mb-2'>Order Placed!</h1>
            <p className='text-gray-600 mx-w-md mb-6'>Thank you for your purchase. <br /> Your order is being prepared.  You can track your order status in the "My Orders" section.</p>
